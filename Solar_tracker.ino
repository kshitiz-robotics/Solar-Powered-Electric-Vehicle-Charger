...
// D6- Load Control
// D8- 2104MOSFET driver SD
// D9- 2104MOSFET driver IN
// D11- Green LED
// D12- Blue LED
// D13- Red LED
...
floatbat_volts;
floatsol_watts;
floatold_sol_watts = 0;
unsignedint seconds = 0;
unsignedintprev_seconds = 0;
unsignedintinterrupt_counter = 0;
unsigned long time = 0;
int delta = PWM_INC;
intpwm = 0;
intback_light_pin_State = 0;
booleanload_status = false;
enumcharger_mode {off, on, bulk, bat_float} charger_state;
...
lcd.begin(20,4);
lcd.backlight();
for (intbatchar = 0; batchar< 6; ++batchar)
{
...
voidrun_charger(void)
{
staticintoff_count = OFF_NUM;
...
voidprint_data(void) // you can skip this part)
{
...
voidlcd_display()
{
staticboolcurrent_backlight_state = -1;
...
intpct = 100.0*(bat_volts - 11.3)/(12.7- 11.3);
